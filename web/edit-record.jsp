...
%>
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <h4> 
                                <input type="hidden"  name="id" value="<%=rs.getString(1)%>"><%=rs.getString(1)%>
                            </h4>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <h4>
                                <input type="text"  name="first name" value="<%=rs.getString(2)%>">
                            </h4>
                        </td>
                    </tr> 
                    ...
                    <tr>
                        ...
                        <td width="60%">
                            <h4>
                                <input type="text" name="last name" value="<%=rs.getString(3)%>">
                            </h4>
                        </td>
                    </tr>
...
%>
                    <tr>
                        ...
                        <td width="60%">
                            <h4>
                                <input type="text" name="class" value="<%=rs.getInt(6)%>">
                            </h4>
                        </td>
                    </tr>  
<%
