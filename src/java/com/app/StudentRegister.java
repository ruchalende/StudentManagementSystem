    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
        {
            ...
            if(count>0)
            {
                ...
                out.println("location='student-register.html';"); 
                out.println("</script>");
            }
            else
            {
                String sql="INSERT INTO student (first_name, last_name, email, password, class, branch_id) VALUES('"+first_name+"','"+last_name+"','"+email+"','"+password+"',"+stu_class+","+branch+");";   
